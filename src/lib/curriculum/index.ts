...
export { chemistry0620, physics0625, definitions, formulas, simulations };
 ...
 */
export const syllabuses: SyllabusSeed[] = [physics0625, chemistry0620];

export function syllabusFor(subject: 'physics' | 'chemistry'): SyllabusSeed {
